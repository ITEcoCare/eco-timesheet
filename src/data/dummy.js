...
import { BiColorFill, BiUserPin } from 'react-icons/bi';
import { IoMdContacts } from 'react-icons/io';
import { RiContactsLine, RiStockLine } from 'react-icons/ri';
import { MdOutlineSupervisorAccount, MdSpaceDashboard } from 'react-icons/md';
import { HiOutlineRefresh, HiClipboardDocumentList } from 'react-icons/hi';
import { TiTick } from 'react-icons/ti';
import { GiLouvrePyramid } from 'react-icons/gi';
import { GrLocation } from 'react-icons/gr';

import { BiHomeAlt } from 'react-icons/bi';
import { BsClipboardData, BsCalendarPlus } from 'react-icons/bs';
import { FaRegCalendarAlt } from 'react-icons/fa'
import { TbHistory, TbLogout, TbTable, TbReport } from 'react-icons/tb';
import { CgProfile, CgClose } from 'react-icons/cg';
import { SiShopware } from 'react-icons/si';
import { ImInsertTemplate, ImLeaf, ImProfile } from 'react-icons/im';
...
export const menuHead = [
  {   
      title: 'Apps', 
      links: [
          { name: 'dashboard', icon: <MdSpaceDashboard size={25} /> },
          { name: 'timesheet', icon: <TbTable size={25} /> },
          { name: 'calendar', icon: <FaRegCalendarAlt size={25} /> },
          { name: 'employee', icon: <BiUserPin size={25} /> },
          { name: 'color_picker', icon: <BiUserPin size={25} /> }
      ],
  },
  {   
      title: 'Reports',
      links: [
          { name: 'report', icon: <TbReport size={25} /> },
  ...
  {   
      title: 'Settings',
      links: [
          { name: 'profile', icon: <CgProfile size={25} />},
          { name: 'department', icon: <CgClose size={25} />},
          { name: 'logout', icon: <TbLogout size={25} />}
      ],
  },
]

// const menu = [
//   { name: 'Home', icon: <MdSpaceDashboard size={25} /> },
//   { name: 'History', icon: <TbHistory size={25} /> },
//   { name: 'Report', icon: <BsClipboardData size={25} /> },
//   { name: 'Profile', icon: <CgProfile size={25} /> },
//   { name: 'Logout', icon: <TbLogout size={25} /> },
// ]
...
export const scheduleData = [
  {
    Id: 1,
    Subject: 'Exp of Betelgeuse Star',
